...
/** Registers and owns persistent feeder/aquarium objects. */
public final class FarmObjectManager implements Listener {
    ...
    public FarmObjectType typeOf(Block block) {
        ...
        if (hasKey(block, "aquarium_shelf_block")) return FarmObjectType.AQUARIUM_SHELF;
        return null;
    }
    ...
    private boolean hasItemKey(ItemStack item, String key) {
